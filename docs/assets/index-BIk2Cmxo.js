(async () => {
  ...
  B.StrictMode = qp;
  B.Suspense = Jp;
  B.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ou;
  B.act = Rd;
  ...
  (function(r) {
    ...
    var p = [], l = [], y = 1, x = null, k = 3, N = false, C = false, S = false, A = typeof setTimeout == "function" ? setTimeout : null, m = typeof clearTimeout == "function" ? clearTimeout : null, b = typeof setImmediate < "u" ? setImmediate : null;
    ...
    var P = false, $ = null, D = -1, H = 5, I = -1;
    function ct() {
      return !(r.unstable_now() - I < H);
    }
    function $t() {
      if ($ !== null) {
    ...
    _l(function() {
      ...
      t: {
        ...
        if (k !== void 0) {
          ...
          var S = (t & 4) !== 0, A = !S && r === "scroll", m = S ? k !== null ? k + "Capture" : null : k;
          S = [];
          for (var b = l, v; b !== null; ) {
            v = b;
            var z = v.stateNode;
            if (v.tag === 5 && z !== null && (v = z, m !== null && (z = ao(b, m), z != null && S.push(fo(b, z, v)))), A) break;
            b = b.return;
          }
      ...
      if (!(t & 7)) {
        t: {
          ...
          if ((N || k) && (k = y.window === y ? y : (k = y.ownerDocument) ? k.defaultView || k.parentWindow : window, N ? (C = e.relatedTarget || e.toElement, N = l, C = C ? Cr(C) : null, C !== null && (A = Xr(C), C !== A || C.tag !== 5 && C.tag !== 6) && (C = null)) : (N = null, C = l), N !== C)) {
            if (S = Nc, z = "onMouseLeave", m = "onMouseEnter", b = "mouse", (r === "pointerout" || r === "pointerover") && (S = Tc, z = "onPointerLeave", m = "onPointerEnter", b = "pointer"), A = N == null ? k : sn(N), v = C == null ? k : sn(C), k = new S(z, b + "leave", N, e, y), k.target = A, k.relatedTarget = v, z = null, Cr(y) === l && (S = new S(m, b + "enter", C, e, y), S.target = v, S.relatedTarget = A, z = S), A = z, N && C) e: {
            ...
            N !== null && Bc(x, k, N, S, false), C !== null && A !== null && Bc(x, A, C, S, true);
          }
        }
        t: {
...
`).replace(Nw, "");
  ...
  function Ul(r) {
    ...
    function C(m, b, v, z) {
      for (var F = null, P = null, $ = b, D = b = 0, H = null; $ !== null && D < v.length; D++) {
        $.index > D ? (H = $, $ = null) : H = $.sibling;
        var I = k(m, $, v[D], z);
        if (I === null) {
          $ === null && ($ = H);
          break;
        }
        r && $ && I.alternate === null && t(m, $), b = n(I, b, D), P === null ? F = I : P.sibling = I, P = I, $ = H;
      }
      ...
      for ($ = s(m, $); D < v.length; D++) H = N($, m, D, v[D], z), H !== null && (r && H.alternate !== null && $.delete(H.key === null ? D : H.key), b = n(H, b, D), P === null ? F = H : P.sibling = H, P = H);
    ...
    function S(m, b, v, z) {
      ...
      for (var P = F = null, $ = b, D = b = 0, H = null, I = v.next(); $ !== null && !I.done; D++, I = v.next()) {
        $.index > D ? (H = $, $ = null) : H = $.sibling;
        ...
        r && $ && ct.alternate === null && t(m, $), b = n(ct, b, D), P === null ? F = ct : P.sibling = ct, P = ct, $ = H;
      }
      ...
      if (typeof v == "object" && v !== null && v.type === _n && v.key === null && (v = v.props.children), typeof v == "object" && v !== null) {
        switch (v.$$typeof) {
          ...
          case en:
            ...
            return c(m);
          case w_:
            return P = v._init, A(m, b, P(v._payload), z);
        }
...
` + n.stack;
    ...
    for (Aa = {
      ...
      try {
        ...
        if (t.flags & 1024) switch (t.tag) {
          ...
          case 1:
            if (C !== null) {
              var S = C.memoizedProps, A = C.memoizedState, m = t.stateNode, b = m.getSnapshotBeforeUpdate(t.elementType === t.type ? S : me(t.type, S), A);
  ...
  var ef = Math.ceil, zs = d_.ReactCurrentDispatcher, Gi = d_.ReactCurrentOwner, we = d_.ReactCurrentBatchConfig, Y = 0, xt = null, ft = null, zt = 0, te = 0, un = mr(0), ht = 0, ko = null, Hr = 0, Qs = 0, tc = 0, to = null, Xt = null, ec = 0, On = 1 / 0, Qe = null, Cs = false, li = null, wr = null, Ao = false, sr = null, Os = 0, eo = 0, pi = null, ns = -1, os = 0;
  function Wt() {
    return Y & 6 ? wt() : ns !== -1 ? ns : ns = wt();
  }
  function fr(r) {
    return r.mode & 1 ? Y & 2 && zt !== 0 ? zt & -zt : Iw.transition !== null ? (os === 0 && (os = cl()), os) : (r = J, r !== 0 || (r = window.event, r = r === void 0 ? 16 : gl(r.type)), r) : 1;
  }
  function Ee(r, t, e, s) {
    if (50 < eo) throw eo = 0, pi = null, Error(O(185));
    So(r, e, s), (!(Y & 2) || r !== xt) && (r === xt && (!(Y & 2) && (Qs |= e), ht === 4 && h_(r, zt)), Gt(r, s), e === 1 && Y === 0 && !(t.mode & 1) && (On = wt() + 500, Is && vr()));
  }
  function Gt(r, t) {
  ...
  function Ep(r, t) {
    if (ns = -1, os = 0, Y & 6) throw Error(O(327));
    var e = r.callbackNode;
  ...
  function _c(r, t) {
    ...
    try {
      ...
      Y = e, Y === 0 && (On = wt() + 500, Is && vr());
    }
  }
  function qr(r) {
    sr !== null && sr.tag === 0 && !(Y & 6) && mn();
    var t = Y;
    Y |= 1;
    ...
    try {
      ...
      J = s, we.transition = e, Y = t, !(Y & 6) && vr();
    }
  }
  function rc() {
    te = un.current, nt(un);
      ...
      try {
        ...
        t: {
          ...
          if (t = zt, d.flags |= 32768, p !== null && typeof p == "object" && typeof p.then == "function") {
            ...
            var A = sd(c);
            if (A !== null) {
              !(A.flags & 65536) && (A.flags |= 256), ad(A, c, d, n, t), Ii(Cn(p, d));
              break t;
            }
          }
  ...
  function Ls(r, t) {
    ...
    while (true);
    if (Mi(), Y = e, zs.current = s, ft !== null) throw Error(O(261));
  ...
  function of(r, t, e, s) {
    ...
    if (Uu(r, n), r === xt && (ft = xt = null, zt = 0), !(e.subtreeFlags & 2064) && !(e.flags & 2064) || Ao || (Ao = true, Tp(ls, function() {
      ...
      J = 1;
      var d = Y;
      Y |= 4, Gi.current = null, Gw(r, e), jp(e, r), Sw(Aa), us = !!Ba, Aa = Ba = null, r.current = e, tf(e), Lu(), Y = d, J = c, we.transition = n;
    } else r.current = e;
    ...
    if (sr !== null) {
      ...
      try {
        if (we.transition = null, J = 16 > r ? 16 : r, sr === null) var s = false;
          ...
          if (r = sr, sr = null, Os = 0, Y & 6) throw Error(O(331));
          var o = Y;
          for (Y |= 4, R = r.current; R !== null; ) {
            var n = R, c = n.child;
            if (R.flags & 16) {
              var d = n.deletions;
              if (d !== null) {
          ...
          if (Y = o, vr(), Ie && typeof Ie.onPostCommitFiberRoot == "function") try {
    ...
    switch (r.tag) {
      case 3:
        ...
        if (t.current.memoizedState.isDehydrated) {
          ...
          e !== 0 && (Ci(t, e | 1), Gt(t, wt()), !(Y & 6) && (On = wt() + 500, vr()));
        }
        break;
      case 13:
        qr(function() {
...
${r.stack}` : s;
  ...
  function gU() {
    ...
    function y(C) {
      const S = Number(C.coin().to_str()), A = C.multiasset(), m = {
        lovelace: S
      };
      if (A) {
        const b = A.keys();
        for (let v = 0; v < b.len(); v++) {
          const z = b.get(v), F = A.get(z), P = F.keys(), D = `policy ${St(z.to_bytes())}`, H = {};
    ...
    function x(C) {
      const S = Pt.from_bech32(C), A = C.startsWith("addr_test") ? "Testnet" : "Mainnet";
      let m = "Shelley", b = null, v = null, z = null, F = null;
      const P = ro.from_address(S);
      if (P) {
        const H = P.payment_cred(), I = H.to_keyhash(), ct = H.to_scripthash();
        ...
        const H = no.from_address(S);
        if (H) {
          const I = H.payment_cred(), ct = I.to_keyhash(), $t = I.to_scripthash();
    ...
    function k(C) {
      ...
      const S = C.body(), A = S.inputs(), m = S.outputs(), b = [];
      for (let V = 0; V < A.len(); V++) {
        const U = A.get(V), Z = St(U.transaction_id().to_bytes());
        b.push(`${Z}#${U.index()}`);
      }
      const v = [];
      ...
      const H = (_a2 = S.reference_inputs) == null ? void 0 : _a2.call(S), I = [];
      if (H) for (let V = 0; V < H.len(); V++) {
    ...
    const N = (C) => {
      ...
      try {
        ...
        const A = J_.from_bytes(wU(S)), m = k(A);
  ...
  Ip(Mp).render(X.jsx(su.StrictMode, {
    children: X.jsx(gU, {})
  }));
})();
