(async () => {
  ...
  var jo = Symbol.for("react.element"), Hu = Symbol.for("react.portal"), qu = Symbol.for("react.fragment"), Yu = Symbol.for("react.strict_mode"), Xu = Symbol.for("react.profiler"), Ku = Symbol.for("react.provider"), Zu = Symbol.for("react.context"), Gu = Symbol.for("react.forward_ref"), Ju = Symbol.for("react.suspense"), tp = Symbol.for("react.memo"), ep = Symbol.for("react.lazy"), gc = Symbol.iterator;
  function _p(r) {
  ...
  function Xo(r, t, e, s, o) {
    ...
    if (c) return c = r, o = o(c), r = s === "" ? "." + Gs(c, 0) : s, bc(o) ? (e = "", r != null && (e = r.replace(hc, "$&/") + "/"), Xo(o, t, e, "", function(l) {
      return l;
    ...
    else if (u = _p(r), typeof u == "function") for (r = u.call(r), d = 0; !(n = r.next()).done; ) n = n.value, u = s + Gs(n, d++), c += Xo(n, t, e, u, o);
  ...
  (function(r) {
    function t(T, M) {
      ...
      T.push(M);
      t: for (; 0 < Q; ) {
        var ot = Q - 1 >>> 1, wt = T[ot];
        if (0 < o(wt, M)) T[ot] = M, T[Q] = wt, Q = ot;
        else break t;
      }
    }
    function e(T) {
    ...
    function s(T) {
      ...
      if (Q !== M) {
        ...
        t: for (var ot = 0, wt = T.length, At = wt >>> 1; ot < At; ) {
          ...
          if (0 > o(Pn, Q)) le < wt && 0 > o(Er, Pn) ? (T[ot] = Er, T[le] = Q, ot = le) : (T[ot] = Pn, T[Ne] = Q, ot = Ne);
          else if (le < wt && 0 > o(Er, Q)) T[ot] = Er, T[le] = Q, ot = le;
          else break t;
        }
      }
      return M;
    ...
    var P = false, R = null, D = -1, Z = 5, B = -1;
    function nt() {
      return !(r.unstable_now() - B < Z);
    }
    function gt() {
      if (R !== null) {
    ...
    r.unstable_IdlePriority = 5, r.unstable_ImmediatePriority = 1, r.unstable_LowPriority = 4, r.unstable_NormalPriority = 3, r.unstable_Profiling = null, r.unstable_UserBlockingPriority = 2, r.unstable_cancelCallback = function(T) {
      ...
      switch (typeof Q == "object" && Q !== null ? (Q = Q.delay, Q = typeof Q == "number" && 0 < Q ? ot + Q : ot) : Q = ot, T) {
        case 1:
          var wt = -1;
          break;
        case 2:
      ...
      return wt = Q + wt, T = {
        ...
        expirationTime: wt,
        sortIndex: -1
      }, Q > ot ? (T.sortIndex = Q, t(l, T), e(u) === null && T === e(l) && (F ? (b(D), D = -1) : F = true, f_(E, Q - ot))) : (T.sortIndex = wt, t(u, T), N || O || (N = true, de(L))), T;
...
` + o[c].replace(" at new ", " at ");
  ...
  function zc(r) {
    if (Jr(r) !== r) throw Error(z(188));
  }
  function Op(r) {
    var t = r.alternate;
    if (!t) {
      if (t = Jr(r), t === null) throw Error(z(188));
      return t !== r ? null : r;
    }
    for (var e = r, s = t; ; ) {
      var o = e.return;
  ...
  var ws = null;
  function Qa(r, t, e, s) {
    if (ws = null, r = zi(s), r = Fr(r), r !== null) if (t = Jr(r), t === null) r = null;
  ...
  function hl() {
    ...
    return Go = o.slice(r, 1 < s ? 1 - s : void 0);
  }
  function Jo(r) {
    var t = r.keyCode;
  ...
  var ow = ct({}, Eo, {
    key: function(r) {
      ...
      return r.type === "keypress" ? (r = Jo(r), r === 13 ? "Enter" : String.fromCharCode(r)) : r.type === "keydown" || r.type === "keyup" ? _w[r.keyCode] || "Unidentified" : "";
    },
    code: 0,
    location: 0,
    ctrlKey: 0,
    ...
    which: function(r) {
      return r.type === "keypress" ? Jo(r) : r.type === "keydown" || r.type === "keyup" ? r.keyCode : 0;
    }
  }), sw = ie(ow), aw = ct({}, Ps, {
    pointerId: 0,
    width: 0,
  ...
  function bw(r, t) {
    if (nn) return r === "compositionend" || !Ri && ml(r, t) ? (r = hl(), Go = Fi = cr = null, nn = false, r) : null;
    switch (r) {
      case "paste":
        return null;
      case "keypress":
  ...
  function kl(r, t, e, s) {
    Jd(s), t = fs(t, "onChange"), 0 < t.length && (e = new Ti("onChange", "change", null, e, s), r.push({
      event: e,
      listeners: t
    }));
  }
    ...
    rl(function() {
      ...
      if (!(t & 7)) {
        t: {
          ...
          if ((O || k) && (k = m.window === m ? m : (k = m.ownerDocument) ? k.defaultView || k.parentWindow : window, O ? (N = e.relatedTarget || e.toElement, O = l, N = N ? Fr(N) : null, N !== null && (I = Jr(N), N !== I || N.tag !== 5 && N.tag !== 6) && (N = null)) : (O = null, N = l), O !== N)) {
...
`).replace(Fw, "");
  ...
  var kr = {}, Dt = jr(kr), Gt = jr(false), qr = kr;
  function Sn(r, t) {
  ...
  function hs(r) {
    return r = (r = r.stateNode) && r.__reactInternalMemoizedMergedChildContext || kr, qr = Dt.current, J(Dt, r), J(Gt, Gt.current), true;
  }
  function Kc(r, t, e) {
    var s = r.stateNode;
    if (!s) throw Error(z(169));
    e ? (r = Rl(r, t, qr), s.__reactInternalMemoizedMergedChildContext = r, rt(Gt), rt(Dt), J(Dt, r)) : rt(Gt), J(Gt, e);
  }
  ...
  function Wo(r) {
    ...
    if (!st) return Gc(r), st = true, false;
    var t;
  ...
  function Ml(r) {
    ...
    function u(b, h, v, E) {
      var L = v.type;
      return L === rn ? m(b, h, v.props.children, E, v.key) : h !== null && (h.elementType === L || typeof L == "object" && L !== null && L.$$typeof === h_ && Jc(L) === h.type) ? (E = o(h, v.props), E.ref = Mn(b, h, v), E.return = b, E) : (E = ss(v.type, v.key, v.props, null, b.mode, E), E.ref = Mn(b, h, v), E.return = b, E);
    }
    function l(b, h, v, E) {
    ...
    function N(b, h, v, E) {
      for (var L = null, P = null, R = h, D = h = 0, Z = null; R !== null && D < v.length; D++) {
        ...
        r && R && B.alternate === null && t(b, R), h = n(B, h, D), P === null ? L = B : P.sibling = B, P = B, R = Z;
      }
    ...
    function F(b, h, v, E) {
      ...
      for (var P = L = null, R = h, D = h = 0, Z = null, B = v.next(); R !== null && !B.done; D++, B = v.next()) {
        R.index > D ? (Z = R, R = null) : Z = R.sibling;
        var nt = k(b, R, B.value, E);
        if (nt === null) {
          R === null && (R = Z);
          break;
        }
      ...
      if (B.done) return e(b, R), st && zr(b, D), L;
      if (R === null) {
        for (; !B.done; D++, B = v.next()) B = x(b, B.value, E), B !== null && (h = n(B, h, D), P === null ? L = B : P.sibling = B, P = B);
        return st && zr(b, D), L;
      }
      for (R = s(b, R); !B.done; D++, B = v.next()) B = O(R, b, D, B.value, E), B !== null && (r && B.alternate !== null && R.delete(B.key === null ? D : B.key), h = n(B, h, D), P === null ? L = B : P.sibling = B, P = B);
            ...
            t: {
              for (var L = v.key, P = h; P !== null; ) {
                if (P.key === L) {
                  ...
                  } else if (P.elementType === L || typeof L == "object" && L !== null && L.$$typeof === h_ && Jc(L) === P.type) {
  ...
  function Ai(r, t) {
    switch (J(ho, t), J(bo, r), J(Qe, Co), r = t.nodeType, r) {
      case 9:
      case 11:
  ...
  var es = p_.ReactCurrentDispatcher, ba = p_.ReactCurrentBatchConfig, Xr = 0, it = null, bt = null, kt = null, Ss = false, Gn = false, yo = 0, Mw = 0;
  function Ft() {
    throw Error(z(321));
  }
  function Yi(r, t) {
  ...
  function Xi(r, t, e, s, o, n) {
    if (Xr = n, it = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, es.current = r === null || r.memoizedState === null ? Bw : Aw, r = e(s, o), Gn) {
      n = 0;
      do {
        if (Gn = false, yo = 0, 25 <= n) throw Error(z(301));
  ...
  var Ms = {
    isMounted: function(r) {
      return (r = r._reactInternals) ? Jr(r) === r : false;
    },
...
` + n.stack;
  ...
  function wu(r, t, e) {
    ...
    if (s.mode === "hidden") if (!(t.mode & 1)) t.memoizedState = {
      ...
      if (!(e & 1073741824)) return r = n !== null ? n.baseLanes | e : e, t.lanes = t.childLanes = 1073741824, t.memoizedState = {
        ...
        cachePool: null,
        transitions: null
      }, t.updateQueue = null, J(wn, ee), ee |= r, null;
      t.memoizedState = {
        baseLanes: 0,
        cachePool: null,
        transitions: null
      }, s = n !== null ? n.baseLanes : e, J(wn, ee), ee |= s;
    }
    else n !== null ? (s = n.baseLanes | e, t.memoizedState = null) : s = e, J(wn, ee), ee |= s;
  ...
  function ld(r, t, e, s, o) {
    ...
    if (mn(t, o), t.stateNode === null) rs(r, t), du(t, e, s), ei(t, e, s, o), s = true;
      ...
      typeof l == "object" && l !== null ? l = he(l) : (l = Jt(e) ? qr : Dt.current, l = Sn(t, l));
      ...
      c.state = k, xs(t, s, c, o), u = t.memoizedState, d !== s || k !== u || Gt.current || y_ ? (typeof m == "function" && (ti(t, e, m, s), u = t.memoizedState), (d = y_ || nd(t, e, d, s, k, u, l)) ? (x || typeof c.UNSAFE_componentWillMount != "function" && typeof c.componentWillMount != "function" || (typeof c.componentWillMount == "function" && c.componentWillMount(), typeof c.UNSAFE_componentWillMount == "function" && c.UNSAFE_componentWillMount()), typeof c.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof c.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = s, t.memoizedState = u), c.props = s, c.state = u, c.context = l, s = d) : (typeof c.componentDidMount == "function" && (t.flags |= 4194308), s = false);
    } else {
      c = t.stateNode, Vl(r, t), d = t.memoizedProps, l = t.type === t.elementType ? d : ke(t.type, d), c.props = l, x = t.pendingProps, k = c.context, u = e.contextType, typeof u == "object" && u !== null ? u = he(u) : (u = Jt(e) ? qr : Dt.current, u = Sn(t, u));
  ...
  function bu(r, t, e) {
    ...
    if ((d = c) || (d = r !== null && r.memoizedState === null ? false : (o & 2) !== 0), d ? (n = true, t.flags &= -129) : (r === null || r.memoizedState !== null) && (o |= 1), J(at, o & 1), r === null) return Ga(t), r = t.memoizedState, r !== null && (r = r.dehydrated, r !== null) ? (t.mode & 1 ? r.data === "$!" ? t.lanes = 8 : t.lanes = 1073741824 : t.lanes = 1, null) : (c = s.children, r = s.fallback, n ? (s = t.mode, n = t.child, c = {
      mode: "hidden",
      children: c
    }, !(s & 1) && n !== null ? (n.childLanes = 0, n.pendingProps = c) : n = Vs(c, s, 0, null), r = Hr(r, s, e, null), n.return = t, r.return = t, n.sibling = r, t.child = n, t.child.memoizedState = si(e), t.memoizedState = oi, r) : Ji(t, c));
  ...
  function Vo(r, t, e, s) {
    return s !== null && Ui(s), zn(t, r.child, null, e), r = Ji(t, t.pendingProps.children), r.flags |= 2, t.memoizedState = null, r;
  }
  function Xw(r, t, e, s, o, n, c) {
    ...
    return o.data === "$?" ? (t.flags |= 128, t.child = r.child, t = cf.bind(null, r), o._reactRetry = t, null) : (r = n.treeContext, re = gr(o.nextSibling), ne = t, st = true, Se = null, r !== null && (ue[pe++] = o_, ue[pe++] = s_, ue[pe++] = Yr, o_ = r.id, s_ = r.overflow, Yr = t), t = Ji(t, s.children), t.flags |= 4096, t);
  }
  function pd(r, t, e) {
    r.lanes |= t;
    var s = r.alternate;
  ...
  function hu(r, t, e) {
    ...
    if (J(at, s), !(t.mode & 1)) t.memoizedState = null;
    else switch (o) {
      case "forwards":
  ...
  function Kw(r, t, e) {
    switch (t.tag) {
      ...
      case 10:
        ...
        J(vs, s._currentValue), s._currentValue = o;
        break;
      case 13:
        if (s = t.memoizedState, s !== null) return s.dehydrated !== null ? (J(at, at.current & 1), t.flags |= 128, null) : e & t.child.childLanes ? bu(r, t, e) : (J(at, at.current & 1), r = u_(r, t, e), r !== null ? r.sibling : null);
        J(at, at.current & 1);
        break;
      case 19:
        ...
        if (o = t.memoizedState, o !== null && (o.rendering = null, o.tail = null, o.lastEffect = null), J(at, at.current), s) break;
        return null;
      case 22:
      case 23:
  ...
  function Zw(r, t, e) {
    ...
    switch (Ii(t), t.tag) {
      ...
      case 14:
        return Tt(t), null;
      case 1:
        return Jt(t.type) && bs(), Tt(t), null;
      case 3:
        return s = t.stateNode, Cn(), rt(Gt), rt(Dt), qi(), s.pendingContext && (s.context = s.pendingContext, s.pendingContext = null), (r === null || r.child === null) && (Wo(t) ? t.flags |= 4 : r === null || r.memoizedState.isDehydrated && !(t.flags & 256) || (t.flags |= 1024, Se !== null && (fi(Se), Se = null))), ai(r, t), Tt(t), null;
      case 5:
        Hi(t);
        var o = Pr(ho.current);
          ...
          if (r = Pr(Qe.current), Wo(t)) {
            ...
            t: {
              ...
              for (n in d) if (d.hasOwnProperty(n)) {
                var u = d[n];
                n === "style" ? Gd(r, u) : n === "dangerouslySetInnerHTML" ? (u = u ? u.__html : void 0, u != null && Kd(r, u)) : n === "children" ? typeof u == "string" ? (e !== "textarea" || u !== "") && so(r, u) : typeof u == "number" && so(r, "" + u) : n !== "suppressContentEditableWarning" && n !== "suppressHydrationWarning" && n !== "autoFocus" && (oo.hasOwnProperty(n) ? u != null && n === "onScroll" && tt("scroll", r) : u != null && xi(r, n, u, c));
              }
              switch (e) {
                case "input":
                  Fo(r), xc(r, s, false);
      ...
      case 19:
        ...
        if (s = (t.flags & 128) !== 0, c = n.rendering, c === null) if (s) Wn(n, false);
          ...
          if (yt !== 0 || r !== null && r.flags & 128) for (r = t.child; r !== null; ) {
            if (c = js(r), c !== null) {
              ...
              return J(at, at.current & 1 | 2), t.child;
            }
            r = r.sibling;
          }
        ...
        return n.tail !== null ? (t = n.tail, n.rendering = t, n.tail = t.sibling, n.renderingStartTime = pt(), t.sibling = null, e = at.current, J(at, s ? e & 1 | 2 : e & 1), t) : (Tt(t), null);
      case 22:
      case 23:
  ...
  function Gw(r, t) {
    switch (Ii(t), t.tag) {
      ...
      case 3:
        return Cn(), rt(Gt), rt(Dt), qi(), r = t.flags, r & 65536 && !(r & 128) ? (t.flags = r & -65537 | 128, t) : null;
      case 5:
        return Hi(t), null;
      case 13:
  ...
  var Bo = false, Rt = false, Jw = typeof WeakSet == "function" ? WeakSet : Set, $ = null;
  function pn(r, t) {
    var e = r.ref;
        ...
        if (s & 4 && (o = r.stateNode, o != null)) {
          ...
          if (r.updateQueue = null, u !== null) try {
            ...
            for (c = 0; c < u.length; c += 2) {
              var m = u[c], x = u[c + 1];
              m === "style" ? Gd(o, x) : m === "dangerouslySetInnerHTML" ? Kd(o, x) : m === "children" ? so(o, x) : xi(o, m, x, l);
            }
            switch (d) {
              case "input":
                La(o, n);
  ...
  function Cu(r, t) {
    do {
      ...
      try {
        ...
        if (Xr = 0, kt = bt = it = null, Gn = false, yo = 0, tc.current = null, e === null || e.return === null) {
          yt = 1, ko = t, ft = null;
          break;
        }
        t: {
  ...
  var Tu;
  Tu = function(r, t, e) {
    if (r !== null) if (r.memoizedProps !== t.pendingProps || Gt.current) Zt = true;
    else {
    ...
    switch (t.lanes = 0, t.tag) {
      case 2:
        ...
        var n = Ki();
        return t.flags |= 1, typeof o == "object" && o !== null && typeof o.render == "function" && o.$$typeof === void 0 ? (t.tag = 1, t.memoizedState = null, t.updateQueue = null, Jt(s) ? (n = true, hs(t)) : n = false, t.memoizedState = o.state !== null && o.state !== void 0 ? o.state : null, Bi(t), o.updater = Ms, t.stateNode = o, o._reactInternals = t, ei(t, s, r, e), t = ni(null, t, s, true, n, e)) : (t.tag = 0, st && n && Di(t), Ut(null, t, o, e), t = t.child), t;
      case 16:
        s = t.elementType;
        t: {
      ...
      case 3:
        ...
        return t;
      case 5:
        return Bl(t), r === null && Ga(t), s = t.type, o = t.pendingProps, n = r !== null ? r.memoizedProps : null, c = o.children, qa(s, o) ? c = null : n !== null && qa(s, n) && (t.flags |= 32), fu(r, t), Ut(r, t, c, e), t.child;
      case 6:
        return r === null && Ga(t), null;
      case 13:
        return bu(r, t, e);
      case 4:
      ...
      case 10:
        t: {
          if (s = t.type._context, o = t.pendingProps, n = t.memoizedProps, c = o.value, J(vs, s._currentValue), s._currentValue = c, n !== null) if (Oe(n.value, c)) {
            if (n.children === o.children && !Gt.current) {
              t = u_(r, t, e);
              break t;
            }
            ...
            if (d !== null) {
              ...
              for (var u = d.firstContext; u !== null; ) {
                if (u.context === s) {
                  ...
                  n.lanes |= e, u = n.alternate, u !== null && (u.lanes |= e), Ja(n.return, e, t), d.lanes |= e;
                  break;
                }
                u = u.next;
              }
      ...
      case 17:
        return s = t.type, o = t.pendingProps, o = t.elementType === s ? o : ke(s, o), rs(r, t), t.tag = 1, Jt(s) ? (r = true, hs(t)) : r = false, mn(t, e), du(t, s, o), ei(t, s, o, e), ni(null, t, s, true, r, e);
      case 19:
        return hu(r, t, e);
      case 22:
        return wu(r, t, e);
  ...
  function Ru(r) {
    ...
    r = r._reactInternals;
    t: {
      if (Jr(r) !== r || r.tag !== 1) throw Error(z(170));
      var t = r;
      do {
        switch (t.tag) {
          case 3:
...
${r.stack}` : s;
  ...
  class Ur {
    ...
    insert_str(t, e) {
      try {
        ...
        f(e, G), _.metadatamap_insert_str(c, this.__wbg_ptr, d, u, e.__wbg_ptr);
        var s = a()[c / 4 + 0], o = a()[c / 4 + 1], n = a()[c / 4 + 2];
        if (n) throw p(o);
        return s === 0 ? void 0 : G.__wrap(s);
      } finally {
  ...
  function mg(r, t) {
    const e = gi(V(t)), s = g(e, _.__wbindgen_malloc, _.__wbindgen_realloc), o = w;
    a()[r / 4 + 1] = o, a()[r / 4 + 0] = s;
  }
  function vg(r, t) {
  ...
  const i = await vf({
    "./cardano_serialization_lib_bg.js": {
      ...
      __wbg_window_f2557cc78490aceb: Gf,
    ...
    costmdls_len: YF,
    costmdls_new: qF,
    costmdls_retain_language_versions: GF,
    ...
    headerbody_has_nonce_and_leader_vrf: Gj,
    ...
    moveinstantaneousrewardscert_new: Gm,
    ...
    plutusdata_new_single_value_constr_plutus_data: GT,
    ...
    transactionbody_set_validity_start_interval: Gb,
    ...
    transactionbuilder_get_total_output: G$,
    ...
    transactionbuilderconfigbuilder_max_value_size: GR,
    ...
    transactionmetadatum_new_map: GL,
    ...
    transactionoutputbuilder_next: GS,
  ...
  function bU() {
    ...
    function m(I) {
      ...
      if (h) {
        ...
        for (let L = 0; L < E.len(); L++) {
          const P = E.get(L), R = h.get(P), D = R.keys(), B = `policy ${Et(P.to_bytes())}`, nt = {};
    ...
    function k(I) {
      ...
      const de = ((_c2 = b.collateral_return) == null ? void 0 : _c2.call(b)) ? Le(b.collateral_return()) : null, f_ = ((_d2 = b.total_collateral) == null ? void 0 : _d2.call(b)) ? Number(b.total_collateral().to_str()) : null, T = (_e2 = b.required_signers) == null ? void 0 : _e2.call(b), M = T ? (() => {
        ...
        return A;
      })() : null, Q = (_f2 = b.withdrawals) == null ? void 0 : _f2.call(b);
      let ot = null;
      if (Q) {
        const A = Q.keys(), U = {};
        for (let X = 0; X < A.len(); X++) {
          const dt = A.get(X), Nt = Q.get(dt);
          try {
        ...
        W.jsxs("div", {
          ...
          children: [
            W.jsxs("a", {
              ...
              className: "star-btn",
              title: "Opens GitHub so you can star the repo (GitHub doesn\u2019t allow auto-star from other sites)",
  ...
  Uu(Wu).render(W.jsx(ap.StrictMode, {
    children: W.jsx(bU, {})
  }));
})();
