...
${r.stack}` : s;
  ...
  const i = await mf({
    ...
    __wbg_bip32privatekey_free: i9,
    __wbg_bip32publickey_free: x9,
    __wbg_block_free: G2,
    __wbg_blockhash_free: k7,
    __wbg_bootstrapwitness_free: Nz,
    __wbg_bootstrapwitnesses_free: Bz,
    ...
    __wbg_ed25519signature_free: Gz,
    ...
    __wbg_vkey_free: G9,
    __wbg_vkeys_free: cz,
    __wbg_vkeywitness_free: pz,
    __wbg_vkeywitnesses_free: vz,
    ...
    bignum_to_str: TE,
    bignum_zero: PE,
    bip32privatekey_as_bytes: g9,
    bip32privatekey_chaincode: m9,
    bip32privatekey_derive: c9,
    bip32privatekey_from_128_xprv: d9,
    bip32privatekey_from_bech32: b9,
    bip32privatekey_from_bip39_entropy: y9,
    bip32privatekey_from_bytes: f9,
    bip32privatekey_from_hex: k9,
    bip32privatekey_generate_ed25519_bip32: p9,
    bip32privatekey_to_128_xprv: l9,
    bip32privatekey_to_bech32: h9,
    bip32privatekey_to_hex: v9,
    bip32privatekey_to_public: w9,
    bip32privatekey_to_raw_key: u9,
    bip32publickey_as_bytes: z9,
    bip32publickey_chaincode: L9,
    bip32publickey_derive: j9,
    bip32publickey_from_bech32: C9,
    bip32publickey_from_bytes: E9,
    bip32publickey_from_hex: F9,
    bip32publickey_to_bech32: O9,
    bip32publickey_to_hex: N9,
    bip32publickey_to_raw_key: S9,
    ...
    blockhash_to_hex: DO,
    bootstrapwitness_attributes: Qz,
    bootstrapwitness_chain_code: Wz,
    bootstrapwitness_from_bytes: Tz,
    bootstrapwitness_from_hex: Rz,
    bootstrapwitness_from_json: Iz,
    bootstrapwitness_new: Vz,
    bootstrapwitness_signature: Mz,
    bootstrapwitness_to_bytes: Fz,
    bootstrapwitness_to_hex: Pz,
    bootstrapwitness_to_js_value: Dz,
    bootstrapwitness_to_json: $z,
    bootstrapwitness_vkey: Uz,
    bootstrapwitnesses_add: Yz,
    bootstrapwitnesses_get: qz,
    bootstrapwitnesses_len: Hz,
    bootstrapwitnesses_new: Az,
    ...
    encode_json_str_to_native_script: s9,
    ...
    privatekey_as_bytes: U9,
    privatekey_from_bech32: D9,
    privatekey_from_extended_bytes: M9,
    privatekey_from_hex: B9,
    privatekey_from_normal_bytes: W9,
    privatekey_generate_ed25519: R9,
    privatekey_generate_ed25519extended: $9,
    privatekey_sign: Q9,
    privatekey_to_bech32: I9,
    privatekey_to_hex: V9,
    ...
    publickey_from_bech32: H9,
    publickey_from_bytes: Y9,
    publickey_from_hex: J9,
    publickey_hash: K9,
    publickey_to_bech32: q9,
    publickey_to_hex: Z9,
    publickey_verify: X9,
    publickeys_add: Jz,
    publickeys_get: Zz,
    ...
    vkeys_len: CO,
    vkeys_new: w7,
    vkeywitness_from_bytes: wz,
    vkeywitness_from_hex: gz,
    vkeywitness_from_json: yz,
    vkeywitness_new: mz,
    vkeywitness_signature: VO,
    vkeywitness_to_bytes: uz,
    vkeywitness_to_hex: fz,
    vkeywitness_to_js_value: hz,
    vkeywitness_to_json: bz,
    vkeywitness_vkey: QO,
    vkeywitnesses_add: Lz,
    vkeywitnesses_from_bytes: xz,
    vkeywitnesses_from_hex: Sz,
    vkeywitnesses_from_json: Cz,
    vkeywitnesses_get: Oz,
    vkeywitnesses_len: zO,
    vkeywitnesses_new: u7,
    vkeywitnesses_to_bytes: kz,
    vkeywitnesses_to_hex: jz,
    vkeywitnesses_to_js_value: zz,
    vkeywitnesses_to_json: Ez,
  ...
  function gU() {
    ...
    function k(C) {
      ...
      for (let B = 0; B < H.len(); B++) {
        const U = H.get(B), Z = St(U.transaction_id().to_bytes());
        b.push(`${Z}#${U.index()}`);
      }
      const v = [];
      for (let B = 0; B < m.len(); B++) {
        const U = m.get(B), Z = U.address().to_bech32(), { network: dt, addressEra: Ot, paymentField: jt, stakeReference: p_, referenceScript: Oo } = x(Z), Ys = y(U.amount());
        v.push({
          address: Z,
          "address era": Ot,
          amount: Ys,
      ...
      if ($) for (let B = 0; B < $.len(); B++) {
        const U = $.get(B), Z = St(U.transaction_id().to_bytes());
        D.push(`${Z}#${U.index()}`);
      }
      const q = (_a2 = S.reference_inputs) == null ? void 0 : _a2.call(S), I = [];
      if (q) for (let B = 0; B < q.len(); B++) {
        const U = q.get(B), Z = St(U.transaction_id().to_bytes());
        I.push(`${Z}#${U.index()}`);
      }
      function ct(B) {
        var _a3;
        ...
        for (let dt = 0; dt < U.len(); dt++) {
          const Ot = U.get(dt), jt = B.get(Ot), p_ = jt.keys(), Ys = `policy ${St(Ot.to_bytes())}`, lc = {};
      ...
      function Bt(B) {
        const U = B.address().to_bech32(), { network: Z, addressEra: dt, paymentField: Ot, stakeReference: jt, referenceScript: p_ } = x(U), Oo = y(B.amount());
        return {
          address: U,
          "address era": dt,
          amount: Oo,
      ...
      const be = ((_c2 = S.collateral_return) == null ? void 0 : _c2.call(S)) ? Bt(S.collateral_return()) : null, Kr = ((_d2 = S.total_collateral) == null ? void 0 : _d2.call(S)) ? Number(S.total_collateral().to_str()) : null, kr = (_e2 = S.required_signers) == null ? void 0 : _e2.call(S), Tn = kr ? (() => {
        const B = [];
        for (let U = 0; U < kr.len(); U++) B.push(St(kr.get(U).to_bytes()));
        return B;
      })() : null, T = (_f2 = S.withdrawals) == null ? void 0 : _f2.call(S);
      let M = null;
      if (T) {
        const B = T.keys(), U = {};
        for (let Z = 0; Z < B.len(); Z++) {
          const dt = B.get(Z), Ot = T.get(dt);
          try {
      ...
      if (he) {
        const B = ((_Q = he.metadata) == null ? void 0 : _Q.call(he)) ?? he.metadata();
        if (B) {
          const U = B.keys(), Z = {};
          for (let dt = 0; dt < U.len(); dt++) {
            const Ot = U.get(dt), jt = B.get(Ot);
            Z[Ot.to_str()] = ie(jt);
          }
      ...
      children: [
        V.jsxs("header", {
          children: [
            ...
            V.jsxs("a", {
              href: "https://github.com/milos-ethernal/cardano-tx-decoder",
              target: "_blank",
  ...
  Ip(Mp).render(V.jsx(su.StrictMode, {
    children: V.jsx(gU, {})
  }));
})();
